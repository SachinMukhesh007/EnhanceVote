...
handler = AzureLogHandler(connection_string='InstrumentationKey=37b36a2b-57d5-4b6b-9194-7af933b7566f')
...
exporter = metrics_exporter.new_metrics_exporter(
  ...
  connection_string='InstrumentationKey=37b36a2b-57d5-4b6b-9194-7af933b7566f')
...
middleware = FlaskMiddleware(
    app,
    exporter=AzureExporter(connection_string="InstrumentationKey=37b36a2b-57d5-4b6b-9194-7af933b7566f"),
