...
az aks enable-addons -a monitoring -n $clusterName -g $resourceGroup --workspace-resource-id "/subscriptions/98eef216-7b9b-43da-8509-c2498c60c1ec/resourceGroups/acdnd-c4-project/providers/Microsoft.OperationalInsights/workspaces/log-analytics-ws"
